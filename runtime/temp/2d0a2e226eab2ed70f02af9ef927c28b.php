<?php /*a:2:{s:56:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/group\update.html";i:1610102537;s:64:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" id="group_name" name="name" value="<?php echo htmlentities($group_info['name']); ?>" placeholder="请输入角色名称" />
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="number" id="group_mpnum" name="mpnum" value="<?php echo htmlentities($group_info['mpnum']); ?>" placeholder="请输入公众号数量" />
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="number" id="group_xcxnum" name="xcxnum" value="<?php echo htmlentities($group_info['xcxnum']); ?>" placeholder="请输入小程序数量" />
        </div>
    </div>
    
    <?php if($group_info['is_sys'] == 0): ?>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'authtree'], function(){
        ...
        $.ajax({
            url: '/admin/group/auth_tree.html?id=<?php echo htmlentities($id); ?>',
            dataType: 'json',
