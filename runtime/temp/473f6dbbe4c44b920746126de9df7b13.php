<?php /*a:2:{s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/system\updatemenu.html";i:1609726646;s:55:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form" action="" style="padding-right: 10px;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" required  lay-verify="required" value="<?php echo htmlentities($meu['name']); ?>" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="pid">
                ...
                <?php if(is_array($menu_cate) || $menu_cate instanceof \think\Collection || $menu_cate instanceof \think\Paginator): $i = 0; $__LIST__ = $menu_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <option <?php if($meu['pid'] == $v['id']): ?>selected<?php endif; ?> value="<?php echo htmlentities($v['id']); ?>"><?php echo htmlentities($v['name']); ?></option>
                        <?php if(is_array($v['child']) || $v['child'] instanceof \think\Collection || $v['child'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
                            <option <?php if($meu['pid'] == $c['id']): ?>selected<?php endif; ?> value="<?php echo htmlentities($c['id']); ?>">   &nbsp;&nbsp;&nbsp; ├<?php echo htmlentities($c['name']); ?></option>
                            ...
                            <option <?php if($meu['pid'] == $d['id']): ?>selected<?php endif; ?> value="<?php echo htmlentities($d['id']); ?>">   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ├<?php echo htmlentities($d['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="url" required  lay-verify="required" value="<?php echo htmlentities($meu['url']); ?>" autocomplete="off" class="layui-input" type="text">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="sort" value="<?php echo htmlentities($meu['sort']); ?>"  placeholder="请输入排序" autocomplete="off" class="layui-input" type="text">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="icon" value="<?php echo htmlspecialchars($meu['icon']); ?>"  placeholder="请输入图标" autocomplete="off" class="layui-input" type="text">
        </div>
