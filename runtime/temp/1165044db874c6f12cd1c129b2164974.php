<?php /*a:2:{s:55:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/material\index.html";i:1609752050;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div style="padding: 0px 10px 0px 10px">
    <div class="layui-btn-group" style=" margin-bottom: 5px;">
        <button onclick="sycMaterial('image')" class="layui-btn layui-btn-sm">
            <i class="layui-icon layui-icon-picture-fine" style="font-size: 14px !important;"></i>同步图片
        </button>
        <button onclick="sycMaterial('news')" class="layui-btn layui-btn-danger layui-btn-sm">
            <i class="layui-icon layui-icon-carousel" style="font-size: 14px !important;"></i>同步图文
        </button>
        <button onclick="sycMaterial('voice')" class="layui-btn layui-btn-normal layui-btn-sm">
            <i class="layui-icon layui-icon-play" style="font-size: 14px !important;"></i>同步语音
        </button>
        <button onclick="sycMaterial('video')" class="layui-btn layui-btn-warm layui-btn-sm">
            <i class="layui-icon layui-icon-video" style="font-size: 14px !important;"></i>同步视频
        </button>
