<?php /*a:2:{s:53:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/member\index.html";i:1609832252;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-tab-content">
        ...
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline" style="width: 70px;">
                        <input type="number"  name="level" value="<?php echo htmlentities($group['level']); ?>" required lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">会员级别，如：0代表最低级别的会员组</div>
                </div>
            </div>
        ...
        <form class="layui-form" action="">
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 80px;">注册方式</label>
                <div class="layui-input-block" style="margin-left: 110px;">
                    ...
                    <div class="layui-form-item" style="margin-right: 140px;">
                        ...
                        <div class="layui-input-block">
                            ...
                            <p class="tip_for_p">注册|登录后跳转的地址；如：http://www.baidu.com/</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!--<div class="layui-form-item">-->
                ...
                <!--</div>-->
            <!--</div>-->
            <div class="layui-form-item" style="border-top:1px solid #e2e2e2;border-bottom: 1px solid #e2e2e2;margin-top: 10px;">
                <label class="layui-form-label" style="width: 80px;">注册福利</label>
                <div class="layui-input-block" style="margin-left: 76px;">
                    <div class="layui-form-item">
