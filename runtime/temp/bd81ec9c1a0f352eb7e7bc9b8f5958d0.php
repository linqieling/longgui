<?php /*a:2:{s:65:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/system\addadminmember.html";i:1548468232;s:55:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            $.post('',data.field,function (res) {
                ...
                if(res.status=='1'){
                    layer.msg(res.msg,{time:1000},function () {
                        location.href="<?php echo url('adminmember'); ?>";
                    });
                }
            })
            return false;
