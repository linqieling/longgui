<?php /*a:2:{s:48:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/mp\menu.html";i:1609847151;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                $html.find('input[name="menu-type"]').on('click', function () {
                    ...
                    var html = function () {
                        switch (type) {
                            ...
                            case 'customservice':
                            case 'text':
                                return '<div class="layui-form-item layui-form-text"><label class="layui-form-label">回复内容</label><div class="layui-input-block"><textarea placeholder="请输入内容" class="layui-textarea" name="content">{content}</textarea></div></div>'.replace('{content}', content);
                            case 'view':
