<?php /*a:3:{s:51:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/app\config.html";i:1609831432;s:51:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/.\app\base.html";i:1609726646;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<dl>
    ...
    <?php if(isset($addonInfo['config']) && !empty($addonInfo['config'])): ?><?php endif; ?>
    <!--暂保留原判断-->
    ...
    <div class="layui-tab">
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="<?php echo htmlentities($v['name']); ?>">
                            <?php if(is_array($v['value']) || $v['value'] instanceof \think\Collection || $v['value'] instanceof \think\Paginator): $k = 0; $__LIST__ = $v['value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rd): $mod = ($k % 2 );++$k;?>
                            <option value="<?php echo htmlentities($rd['value']); ?>" <?php if(isset($rd['selected'])): if($rd['selected'] == '1'): ?>selected<?php endif; ?><?php endif; ?>><?php echo htmlentities($rd['title']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <p class="tip_for_p"><?php echo htmlentities($v['tip']); ?></p>
                    </div>
                ...
                <?php break; ?>
                    <?php endswitch; ?>
                <?php endforeach; endif; else: echo "" ;endif; if(!(empty($themes) || (($themes instanceof \think\Collection || $themes instanceof \think\Paginator ) && $themes->isEmpty()))): ?>
                <div class="layui-form-item">
