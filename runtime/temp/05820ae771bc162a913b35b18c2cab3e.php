<?php /*a:2:{s:50:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/mp\qrcode.html";i:1609898461;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <tr>
                ...
                <td><?php if($vo['qr_type'] == '0'): ?>临时
                    <?php else: ?> 永久
                    <?php endif; ?></td>
                <td><?php if($vo['qr_type'] == '0'): ?><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($vo['create_time']+$vo['expire'])? strtotime($vo['create_time']+$vo['expire']) : $vo['create_time']+$vo['expire'])); else: ?> 长期有效
                    <?php endif; ?></td>
                <td>
