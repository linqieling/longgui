<?php /*a:1:{s:56:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/system\login.html";i:1609833079;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
                        ...
                        <li>
                            <div class="layui-row">
                                ...
                                <div class="layui-col-md6" style="padding-left: 10px;">
                                    <img id="verifyImg" src="<?php echo url('verify'); ?>" onclick="this.src='<?php echo url('verify'); ?>?'+Math.random();">
                                </div>
                            </div>
                        </li>
...
<div class="footer" style="position: fixed;bottom: 0;left: 0;right: 0;">
    <div class="wrap">
        <a href="https://www.rhaphp.com" target="_blank" style="color: transparent;">官方社区</a>
        <i class="vs" style="color: transparent;">|</i>
        <span style="color: transparent;">Powered By RhaPHP Copyright © <?php echo date('Y'); ?> All Rights Reserved.</span>
    </div>
    <div class="wrap">
        Powered By 微信平台管理系统 Copyright © <?php echo date('Y'); ?> All Rights Reserved.
    </div>
</div>
