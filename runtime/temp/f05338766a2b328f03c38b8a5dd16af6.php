<?php /*a:2:{s:58:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/appstore\index.html";i:1609726646;s:55:"F:\phpstudy\WWW\rhaphp\themes/pc/admin/common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="layui-col-md8">
                    <span id="apps-cate-lists" class="layui-breadcrumb app_nav" lay-separator="|">
                      ...
                      <a href="<?php echo url('index',['type'=>$type,'cate'=>$v['cid']]); ?>">
                          <?php if($cate_id == $v['cid']): ?> <span class="cite"><?php echo htmlentities($v['cate_name']); ?></span><?php else: ?><?php echo htmlentities($v['cate_name']); ?><?php endif; ?>
                          </a>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </span>
                </div>
