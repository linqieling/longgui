<?php /*a:2:{s:53:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/index\mplist.html";i:1609812857;s:61:"F:\phpstudy\WWW\rhaphp\themes/pc/mp/..\admin\common\base.html";i:1609832566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <?php if(is_array($mpList) || $mpList instanceof \think\Collection || $mpList instanceof \think\Paginator): $i = 0; $__LIST__ = $mpList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                <td>
                    <div class="mp-logo">
                        <div class="logo-left">
                            <img src="<?php if($vo['logo']): ?><?php echo htmlentities($vo['logo']); else: ?>/public/static/images/header.jpg<?php endif; ?>">
                        </div>
                    </div>
